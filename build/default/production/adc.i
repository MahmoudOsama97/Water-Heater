...
AdcChannel ArrayOfAdcChannels[8];
...
{
    {PortA,Pin0,PORT_PIN_IN,0,NO_PULL},
    {PortA,Pin1,PORT_PIN_IN,0,NO_PULL},
    {PortA,Pin1,PORT_PIN_IN,0,NO_PULL},
    {PortA,Pin1,PORT_PIN_IN,0,NO_PULL}
};
...
void Adc_init(Adc_ConfigType* Adc_Config)
{
    for(int i=0 ; i<Adc_Config->Adc_NbChannels; i++)
    {
        ...
        (ADCON0 |= ((Adc_Config->Adc_Prescale & 0x04) << 4));
        (ADCON0 |= (Adc_Config->Adc_ResultAlignment << 7));
    }
    ADCON1 |= (0x2<<0);
    ADCON0 |= (1>>0);
