...
Port_ConfigType Port_Config[4] = {
    {PortC,Pin5,PORT_PIN_OUT,(1u),NO_PULL},
    {PortD,Pin1,PORT_PIN_OUT,(1u),NO_PULL},
    {PortD,Pin2,PORT_PIN_OUT,(1u),NO_PULL},
    {PortB,Pin1,PORT_PIN_IN,(0u),PULL_UP}
};

void main(void) {
    Port_Init(&Port_Config[0]);
    Port_Init(&Port_Config[3]);
    while(1)
    {
        if(Dio_ReadChannel(0))
             Dio_WriteChannel(1,(0u));
